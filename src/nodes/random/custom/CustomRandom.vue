...
export default class CustomRandom extends Vue {
                ...
                xAxes: [{
                    ticks: {
                        ...
                        callback: (label, index, labels) => {
                            ...
                            return Math.round((label / 100 * (this.max - this.min) + this.min) * Math.pow(10, this.digits)) / Math.pow(10, this.digits);
                        }
                    },
                    gridLines: {
                        color: this.gridColor,
    ...
    setupPoints() {
        ...
        this.points = [];
        const points: Array<Point2D> = this.points;
    ...
    setChartData(data: Array<Point2D>) {
    ...
    orderedInsert (data: Array<Point2D>, point: Point2D) {
