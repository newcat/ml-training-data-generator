...
\begin{itemize}
    ...
    \item Trapez
\end{itemize}
In jedem Fall aber kann der Flächeninhalt mit der Trapezformel näherungsweise berechnet werden. Der Hintegrund ist, dass eine mithilfe einer Geraden der Breich zwischen den Punkten näherungsweise interpoliert wird.\\
