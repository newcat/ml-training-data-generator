...
\begin{itemize}
    ...
    \item Debugging: Werden unerwartete Trainingsdaten generiert, können mithilfe von Seeds einzelne Änderungen vorgenommen werden, sodass die neuen Daten mit den letzten abgeglichen werden können. Aufgedeckte Singularitäten können so aufgedeckt und reproduziert werden. \todo{Bitte what? Singularitäten? Satzbau? lol}
\end{itemize}
...
\todo{Muss das hier nicht alles diskret heißen statt stetig?}
...
Wählt man zwei aufeinanderfolgende Punkte der diskreten Wahrscheinlichkeitsverteilung $(x_n,y_n)$ und $(x_{n+1},y_{n+1})$, dann ist der Flächeninhalt $A_n$ definiert durch
$$A_n=(x_{n+1}-x_n)*y_n$$
