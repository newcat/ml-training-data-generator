...
\begin{quote}
    ...
    \begin{itemize}
        ...
        \item Die Anzahl der \textbf{Räume} ist abhängig von der Fläche. Dabei gilt folgender Zusammenhang: $\textrm{Räume} = \textrm{Fläche} / 40$. Dies gilt in 80\% aller Fälle. In 10\% der Fälle hat eine Wohnung einen Raum mehr als mit der Formel berechnet, in 10\% der Fälle einen Raum weniger.
